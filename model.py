...
def _preprocess_data(data):
    ...
    feature_vector_df['time_of_day'] = feature_vector_df['time'].dt.hour
    predict_vector = feature_vector_df[['Madrid_wind_speed','Bilbao_rain_1h','Valencia_wind_speed','Madrid_temp']]
    # ------------------------------------------------------------------------
